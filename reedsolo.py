...
# Modification: converted Sieve of Eratosthenes from pure-python to numpy
def rwh_primes1(n):
...
def find_prime_polys(generator=2, c_exp=8, fast_primes=False, single=False):
    ...
    if fast_primes:
        ...
        # Modification: Change list comprehension to numpy array filter syntax execution for speed
        prim_candidates = prim_candidates[prim_candidates > field_charac]
    else:
